...
export default function StartScreen({ navigation }) {
    return (
        <View style={globalStyles.container}>
          ...
          <TouchableOpacity style={globalStyles.startBtn} onPress={() => navigation.navigate('Login')}>
              <Text style={{fontSize: 15},globalStyles.ButtonsText}>LOGIN</Text>
          </TouchableOpacity> 
          <TouchableOpacity style={globalStyles.startBtn}onPress={() => navigation.navigate('SignUp')}>
